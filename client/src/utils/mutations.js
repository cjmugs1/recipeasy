...
mutation addRecipe($userId: ID!, $name: String!, $description: String!, $ingredients: [IngredientInput]!, $instructions: [String]!, $cookTime: TimeInput!) {
  addRecipe(userId: $userId, name: $name, description: $description, ingredients: $ingredients, instructions: $instructions, cookTime: $cookTime) {
    username,
    recipes {
      name
      instructions
